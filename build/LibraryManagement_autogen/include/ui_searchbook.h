...
public:
    ...
    void setupUi(QMainWindow *SearchBook)
    {
        ...
        SearchBook->resize(1000, 650);
        SearchBook->setMinimumSize(QSize(1000, 650));
        SearchBook->setMaximumSize(QSize(1000, 650));
        SearchBook->setStyleSheet(QString::fromUtf8("QWidget{\n"
...
"}"));
        ...
        txtAuthor2Name = new QLineEdit(centralwidget);
        txtAuthor2Name->setObjectName("txtAuthor2Name");
        txtAuthor2Name->setGeometry(QRect(650, 80, 315, 28));
    ...
    {
        SearchBook->setWindowTitle(QCoreApplication::translate("SearchBook", "MainWindow", nullptr));
        label->setText(QCoreApplication::translate("SearchBook", "Access No", nullptr));
        label_2->setText(QCoreApplication::translate("SearchBook", "Book Name", nullptr));
        label_3->setText(QCoreApplication::translate("SearchBook", "Author1 Name", nullptr));
        label_4->setText(QCoreApplication::translate("SearchBook", "Author2 Name", nullptr));
