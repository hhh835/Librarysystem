...
template <> constexpr inline auto EditUser::qt_create_metaobjectdata<qt_meta_tag_ZN8EditUserE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<EditUser, qt_meta_tag_ZN8EditUserE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject EditUser::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8EditUserE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8EditUserE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN8EditUserE_t>.metaTypes,
    nullptr
} };
...
void *EditUser::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8EditUserE_t>.strings))
